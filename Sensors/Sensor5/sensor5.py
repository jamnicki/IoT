# DATA SOURCE: https://www.kaggle.com/garystafford/environmental-sensor-data-132k
import json
import pandas as pd
import requests
import time
    ...
    for _, row in data.iterrows():
        ...
        if config['base']['broadcast_mode']:
            ...
            if config['base']['method'] == 'http':
                try:
                    r = requests.get(config['http']['address'], data={'Sensor5': json.dumps(DATA)})
